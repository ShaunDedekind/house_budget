  ...
  return (
    <div className="flex flex-col gap-6 pb-16">
            ...
            <div className="divide-y divide-zinc-50">
              ...
              {categories.map(category => (
                ...
                >
                  ...
                  <form
                    action={upsertBudgetItem as unknown as (formData: FormData) => Promise<void>}
      ...
      <section className="bg-white rounded-2xl border border-zinc-100 p-4 flex flex-col gap-3">
        ...
        <form action={createCategory as unknown as (formData: FormData) => Promise<void>} className="flex flex-col gap-3">
          <Input
            id="name"
            name="name"
            label="Category name"
